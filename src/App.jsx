...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route 
        path="/admin-haha" 
        element={user && (user.role === 'admin' || user.role === 'super-admin') ? <AdminDashboard /> : <Navigate to="/user/login" />} 
      />
      <Route 
        path="/admin-haha/edit/:productid" 
        element={user && (user.role === 'admin' || user.role === 'super-admin') ? <EditProduct /> : <Navigate to="/user/login" />} 
      />
      <Route 
      ...
      />
      <Route 
        path="/admin-haha/enquiries" 
        element={user && (user.role === 'admin' || user.role === 'super-admin') ? <Enquiries /> : <Navigate to="/user/login" />} 
      />
      ...
      <Route path="/account/recently-viewed" element={<RecentlyViewed />} />
